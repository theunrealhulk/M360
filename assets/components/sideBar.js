        ...
        <button @click="selectedLevel = 'lastLevel'" :class="{'selected': selectedLevel === 'lastLevel'}" class="border-2 border-black rounded-full p-2 block m-auto mt-5">
            ...
            <hr />
                <span class="flex justify-between">
                    <span class="mt-5 m-auto w-2">By</span>
                    <a href="https://decoversestudio.com/" target="_blank"><img class=" mt-4 mr-3 w-24" src="assets/decovers_logo.png" alt="decovers-logo" /></a>
                </span>
            </div>
