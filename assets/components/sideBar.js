export default {
    ...
    <div id="sidebar" class="p-4 absolute top-0 left-0 w-64 z-40" style="height:100vh;">
        ...
        <button @click="selectedLevel = 'firstLevel'" :class="{'selected': selectedLevel === 'firstLevel'}" class="border-2 border-black rounded-full p-2 block m-auto mt-5">
            ...
            <button @click="selectedLevel = 'lastLevel'" :class="{'selected': selectedLevel === 'lastLevel'}" class="border-2 border-black rounded-full p-1.5 block m-auto mt-5">
